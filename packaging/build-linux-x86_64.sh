...
cp packaging/install.sh packaging/service.env.example packaging/mcp.env.example packaging/itsm-workflow-api.service.in packaging/itsm-workflow-worker.service.in packaging/itsm-workflow-migrate.service.in packaging/itsm-workflow-mcp.service.in packaging/itsm-workflow-compiler.service.in packaging/verify-release.py packaging/verify-glibc.py "$STAGE/"
